...
class SimpleMEMSCTRNNCell(DropoutRNNCellMixin, base_layer.BaseRandomLayer):
  ...
  def call(self, inputs, states, training=None):
    ...
    a= tf.constant(4.9311 * (10 ** -20)) # define as hyper-paramter in the future
    d= tf.constant(41.8 * (10 ** -6))# define as hyper-paramter in the future
    ...
    if self.implementation == 1:
      ...
      sigmiod__new_z_minus_d=tf.keras.activations.sigmoid(new_z_minus_d)
